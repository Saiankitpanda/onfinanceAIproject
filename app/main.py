...
from app.api.routes_documents import limiter as documents_limiter
...
if SENTRY_DSN:
    ...
    sentry_sdk.init(
        dsn=SENTRY_DSN, integrations=[sentry_logging], traces_sample_rate=0.1
    )
...
@app.get("/health")
def health_check():
    return {"status": "ok", "service": "ClauseMark Backend"}
